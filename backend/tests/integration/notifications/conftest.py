"""Notifications integration fixtures (EP09-01) — same stack as market."""
...
def redis_url() -> str:
    ...
    if not url:
        pytest.skip("REDIS_URL not set — skipping notifications integration tests")
    return url


@pytest.fixture(autouse=True)
def _notifications_test_env(monkeypatch: pytest.MonkeyPatch, db_url: str, redis_url: str) -> None:
