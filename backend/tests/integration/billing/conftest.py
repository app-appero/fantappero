"""Billing integration fixtures (EP11-01/02) — same stack as market/notifications."""
...
def redis_url() -> str:
    ...
    if not url:
        pytest.skip("REDIS_URL not set — skipping billing integration tests")
    return url


@pytest.fixture(autouse=True)
def _billing_test_env(monkeypatch: pytest.MonkeyPatch, db_url: str, redis_url: str) -> None:
