"""Fantasy team integration fixtures (EP05-01) — same stack as leagues."""
...
def redis_url() -> str:
    ...
    if not url:
        pytest.skip("REDIS_URL not set — skipping fantasy team integration tests")
    return url


@pytest.fixture(autouse=True)
def _fantasy_team_test_env(monkeypatch: pytest.MonkeyPatch, db_url: str, redis_url: str) -> None:
