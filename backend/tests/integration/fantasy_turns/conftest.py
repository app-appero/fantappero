"""Fantasy turn integration fixtures (EP06-01)."""
...
def redis_url() -> str:
    ...
    if not url:
        pytest.skip("REDIS_URL not set — skipping fantasy turn integration tests")
    return url


@pytest.fixture(autouse=True)
def _fantasy_turn_test_env(monkeypatch: pytest.MonkeyPatch, db_url: str, redis_url: str) -> None:
