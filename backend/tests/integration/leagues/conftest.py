"""League integration test fixtures (EP03-01)."""
...
def redis_url() -> str:
    ...
    if not url:
        pytest.skip("REDIS_URL not set — skipping league integration tests")
    return url


@pytest.fixture(autouse=True)
def _league_test_env(monkeypatch: pytest.MonkeyPatch, db_url: str, redis_url: str) -> None:
