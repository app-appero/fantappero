"""Fantasy lineup integration fixtures (EP06-02)."""
...
def redis_url() -> str:
    ...
    if not url:
        pytest.skip("REDIS_URL not set — skipping fantasy lineup integration tests")
    return url


@pytest.fixture(autouse=True)
def _fantasy_lineup_test_env(monkeypatch: pytest.MonkeyPatch, db_url: str, redis_url: str) -> None:
