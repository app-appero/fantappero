"""Market integration fixtures (EP08-01) — same stack as fantasy_teams."""
...
def redis_url() -> str:
    ...
    if not url:
        pytest.skip("REDIS_URL not set — skipping market integration tests")
    return url


@pytest.fixture(autouse=True)
def _market_test_env(monkeypatch: pytest.MonkeyPatch, db_url: str, redis_url: str) -> None:
