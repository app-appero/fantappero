"""Admin panel integration test fixtures (EP11-04a / EP-turni-calcolo)."""
...
def redis_url() -> str:
    ...
    if not url:
        pytest.skip("REDIS_URL not set — skipping admin integration tests")
    return url


@pytest.fixture(autouse=True)
def _admin_test_env(monkeypatch: pytest.MonkeyPatch, db_url: str, redis_url: str) -> None:
