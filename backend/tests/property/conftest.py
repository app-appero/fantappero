"""Fixtures for property-based tests (EP12-02) — same stack as integration tests."""
...
def redis_url() -> str:
    ...
    if not url:
        pytest.skip("REDIS_URL not set — skipping property tests")
    return url


@pytest.fixture(autouse=True)
def _property_test_env(monkeypatch: pytest.MonkeyPatch, db_url: str, redis_url: str) -> None:
