...
| `POST` | `/leagues/{id}/amministrazione/squadre/{teamId}/rosa/random` | `league:admin` — riempie slot vuoti di un fantallenatore IA con calciatori liberi random (1 credito/giocatore di default) |
